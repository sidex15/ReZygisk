...
ReZygisk es un fork de Zygisk Next, una implementación independiente de Zygisk, que provee soporte para la API de Zygisk en KernelSU, APatch y Magisk (Oficial y Kitsune).
